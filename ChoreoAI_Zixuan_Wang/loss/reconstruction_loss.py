...
class ReconstructionLoss(nn.Module):
    ...
    def forward(self, pred_data_1, pred_data_2, target_1, target_2, mean_1, log_var_1, mean_2, log_var_2, mean_duet, log_var_duet, is_simplified_model, out_1, out_2, dancer1_data, dancer2_data):
