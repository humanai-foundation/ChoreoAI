...
#     def forward(self, d1, d2, no_input=False):
#         # proximity
...
# class DancerTransformerWithNoInputProb(nn.Module):
#     def __init__(self, linear_num_features, n_head, latent_dim, n_units, seq_len):
#         super(DancerTransformerWithNoInputProb, self).__init__()
...
#         no_input = torch.randn(1) < self.no_input_prob
